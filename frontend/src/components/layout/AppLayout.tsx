          ...
          return (
            <div className={cn(
              ...
              {isError ? (
                ...
                <div className="shrink-0 mt-0.5 text-accent flex items-center justify-center w-[18px] h-[18px] rounded-full border-2 border-accent">
                  <span className="text-[10px] font-bold">✓</span>
                </div>
              )}
              <div className="flex-1 min-w-0">
                <h4 className="text-sm font-semibold mb-1 text-fg">{isError ? 'Atención' : 'Éxito'}</h4>
